...
Create a map that displays a point for every city in the city_data_df DataFrame as shown in the following image. https://static.bc-edx.com/data/dl-1-2/m6/lms/img/humidity_map.png.
